...
<head>
   ...
   <!-- Page Title -->
   <title>Xprosik - Landing Page for Saas & Software</title>
   <!-- Favicon Icon -->
...
<body>
   ...
   <div class="main-site">
      ...
      <!-- Header Area Start-->
      <header class="sticky-header home-3">
         <div class="container">
            <div class="row">
                        ...
                        <ul>
                           <li class="dropdown"><a href="#" data-scroll-nav="0">Home</a>
                              <ul>
                                 ...
                                 <li><a href="index4.html">Apps Landing </a>
                                 </li>
                              </ul>
                           </li>
               ...
               <div class="col-lg-8">
                  ...
                  <div class="blog-post">
                     ...
                     <div class="blog-posts-meta">
                        <ul>
                           <li><i class="fa fa-calendar"></i>29 April 2019</li>
                           <li><i class="fa fa-comment-o"></i>28 Comments</li>
                           <li><i class="fa fa-eye" ></i>350 Views</li>
                           <li><i class="fa fa-folder-open-o"></i>finace</li>
                        </ul>
                     </div>
                     <h3 class="blog-title">
                        <a href="single-blog.html">Best Saas Software Tips You Will Read This Year</a>
                     </h3>
                     <p>So I said knackered do one ummm I'm telling up the kyver arse over tit smashing lurgy lost the plot, owt to do with me plastered easy peasy ...</p>
                     <a href="single-blog.html" class="read-more-btn read-more">Read more </a>
                  </div>
                  <!-- Single Blog Post End -->
                  <!-- Single Blog Post -->
                  <div class="blog-post">
                     <div class="post-thumb">
                        <img src="assets/img/blog-post4.png" alt="">
                     </div>
                     <div class="blog-posts-meta">
                        <ul>
                           <li><i class="fa fa-calendar"></i>29 April 2019</li>
                     ...
                     <h3 class="blog-title">
                        <a href="single-blog.html">Unlimited Tips for Saas Software  You Will Read This month</a>
                     </h3>
                     <p>So I said knackered do one ummm I'm telling up the kyver arse over tit smashing lurgy lost the plot, owt to do with me plastered easy peasy ...</p>
                     <a href="single-blog.html" class="read-more-btn read-more">Read more</a>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="widget latest-news-widget">
                              <h4>Latest News</h4>
                              <div class="row ml-0 mr-0 bdr">
                                 <div class="col-md-4 col-sm-12 col-xs-12 float-left ml-0 mr-0 px-0">
                                    <a href="single-blog.html"><img src="assets/img/latest-news3.png" alt=""></a>
                                 </div>
                                 <div class="col-md-8 col-sm-12 col-xs-12 text-left float-right px-0">
                                    <div class="latest-news-title">
                                       <p class=""><a href="single-blog.html">Building Diverse Design Was Teams Innovation.</a></p>
                                       <p>05 jan 2019</p>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="widget category-widget">
                              <h4>Category</h4>
                              <ul class="category">
                                 <li><a href="#">Web Developemnt<span>(02)</span></a></li>
                                 <li><a href="#">Digital Marketing<span>(17)</span></a></li>
                                 <li><a href="#">App Developemnt<span>(32)</span></a></li>
                                 <li><a href="#">facebook marketing<span>(24)</span></a></li>
                                 <li><a href="#">Business Solution<span>(20)</span></a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="cta-box">
                     <div class="row">
                        ...
                        <div class="col-md-4"> <a href="#" class="cta-btn black">Get Started Now</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-8 offset-md-2">
                     <div class="subscribe-box home-3">
                        ...
                        <form class="subscribe-form" action="#" method="post">
                           ...
                           <button type="submit" class="subscribe-btn btn black grdnt-blue">Subscribe Now!</button>
                        </form>
                     </div>
