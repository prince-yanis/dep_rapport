...
class InfrastructureController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Infrastructure';
    ...
    protected function grid()
    {
        ...
        $grid->model()->where('infrastructures.etablissementannees_id', Auth::guard('admin')->user()->idEtab);

        $current_user = Auth::guard('admin')->user();
        $current_role = AdminRoleUser::where('user_id', $current_user->id)->first();
        $current_school = Etablissement::where('email', '=', $current_user->username)->first();
        ...
        $grid->column('nombrebureaux', __('Nombre de bureaux'));
        $grid->column('capacite', __('Capacite par salle'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('nombrebureaux', __('Nombre de bureaux'));
        $show->field('capacite', __('Capacite par salle'));
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
			...
			<span class="numberCircle" style="background-color: gray;font-weight: bold;">6</span>
    ...
    $current_school = Etablissement::where('email', '=', $current_user->username)->first();
        ...
        $form->saved(function (Form $form) {
            ...
            //   return redirect('admin/personnels/create');
              return redirect('/admin/besoininfrastructures/create');
