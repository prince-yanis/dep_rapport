...
class EtablissementanneeFiliereAutoriseController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <h1 style="text-align:center; text-transform:uppercase;">Résultat des apprenants</h1>
                <span style="font-size: 14px";><a href="/admin/etablissementdetails/' . $EtabAnnee->id . '/edit">Détails</a></span>
                <span >|</span>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneefiliereautorise/' . $EtabAnnee->id . '/edit">Filières Autorisées</a></span>
                <span >|</span>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a href="/admin/etabanneeplanning/' . $EtabAnnee->id . '/edit">Planning</a></span>
                <span >|</span>
                <span style="font-size: 14px";><a href="/admin/etabanneeresultat/' . $EtabAnnee->id . '/edit">Résultat-Apprenant</a></span>
            </div>
            ');

        $form->hasMany('filiereautorises', __(''), function (Form\NestedForm $form) {
            $lesetabannees = array();
            ...
            $form->select('etablissementannees_id', __('Etablissement annees'))->options($lesetabannees);
