...
use App\Models\TcdFiliereAutorise;
use Illuminate\Support\Facades\Auth;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\TcdFiliereAutoriseExport;
use Encore\Admin\Controllers\AdminController;

class TcdFiliereAutoriseExportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'TcdFiliereAutorise';
    ...
    {
        $grid = new Grid(new TcdFiliereAutorise());
		...
		$grid->tools(function ($tools) {
			$tools->append("<a href='tcdfiliereautorise/export' class='btn btn-primary' target='_blank'>Export vers Excel</a>");
		});
    ...
    {
        $show = new Show(TcdFiliereAutorise::findOrFail($id));
    ...
    {
        $form = new Form(new TcdFiliereAutorise());
    ...
    {
        return Excel::download(new TcdFiliereAutoriseExport, 'Tcd_filiere_autorise.xlsx');
    }
}
