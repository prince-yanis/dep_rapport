...
class SuiviResultatscontrole_5Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Relation avec le milieu professionnel</h1>
        ...
        <span><a href="/admin/suivicontrole_4/' . $resultatscontrole_4->id . '/edit">Gestion financière et juridique</a></span> |
            <span>Relation avec le milieu professionnel</span> |
        ...
        switch ($role_id) {
            case 2:
                ...
                $form->hasMany('detailsresultatscontroles', __('Détails'), function (Form\NestedForm $form) {
                    ...
                    $form->select('itemscontrole_id', __('Items controle'))->options($lesitems)->readOnly();
                    ...
                    $form->radio('existence', __('Existence'))->options(['0' => 'Non', '1' => 'Oui']);
                ...
                $form->saved(function (Form $form) {
                    ...
                    return redirect('admin/suivicontrole_6/' . $resultatscontrole->id . '/edit');
                });
            ...
            default:
                ...
                $form->hasMany('detailsresultatscontroles', __('Détails'), function (Form\NestedForm $form) {
                    ...
                    // $form->number('itemscontrole_id', __('Itemscontrole id'));
                    $form->radio('existence', __('Existence'))->options(['0' => 'Non', '1' => 'Oui'])->attribute('class', 'form-control no-spin');
                    $form->textarea('observations', __('Observations'));
                    // $form->number('resultatscontrole_id', __('Resultatscontrole id')); 
                })->useTable();
                $form->textarea('observationpartielles', __('Observation partielles'));
