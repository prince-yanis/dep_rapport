...
class AssociationController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        if (!(Auth::guard('admin')->user()->id == 0)) {
            $grid->model()->where('associations.etablissementannees_id', Auth::guard('admin')->user()->idEtab);
        }
        ...
        $grid->column('designation', __('Désignation'));
        $grid->column('objet', __('Objet'));
        $grid->column('nomresponsable', __('Nom du responsable'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('designation', __('Désignation'));
        $show->field('objet', __('Objet'));
        $show->field('nomresponsable', __('Nom du responsable'));
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
			...
			<span class="numberCircle" style="background-color: gray;font-weight: bold;">10</span>
...
');
        ...
        $form->text('designation', __('Désignation'));
        ...
        $form->saved(function (Form $form) {
            ...
            //   return redirect('admin/personnels/create');
              return redirect('/admin/apprenants/create');
