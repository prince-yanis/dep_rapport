...
class ClasseController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        if (!(Auth::guard('admin')->user()->id == 0)) {
            $grid->model()->where('classes.etablissementannees_id', Auth::guard('admin')->user()->idEtab);
        }
        ...
        $grid->groupepedagogiques_id()->display(function ($id) {
    ...
    protected function form()
    {
        ...
        //         ->first();
        // 	$mesDonnees = $EtabAnnee->etablissementannees_id;
        // 		//dd($DonneeEtab);
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
			...
			<span class="numberCircle" style="background-color: gray;font-weight: bold;">8</span>
    ...
    $lesgroupes = array();
        ...
        $form->saved(function (Form $form) {
            ...
            //   return redirect('admin/personnels/create');
              return redirect('/admin/activitesportives/create');
