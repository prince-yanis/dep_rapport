...
class EtablissementanneePlanning1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeplanning1er/' . $EtabAnnee->id . '/edit">Planning</a></span>
    </div>
            ');
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etablissements1er');
