...
use App\Models\TcdBesoinPersonnelEn;
use Illuminate\Support\Facades\Auth;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\TcdBesoinPersonnelEnsExport;
use Encore\Admin\Controllers\AdminController;

class TcdBesoinPersonnelEnsExportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'TcdBesoinPersonnelEn';
    ...
    {
        $grid = new Grid(new TcdBesoinPersonnelEn());
		...
		$grid->tools(function ($tools) {
			$tools->append("<a href='tcdbesoinpersonnelens/export' class='btn btn-primary' target='_blank'>Export vers Excel</a>");
		});
    ...
    {
        $show = new Show(TcdBesoinPersonnelEn::findOrFail($id));
    ...
    {
        $form = new Form(new TcdBesoinPersonnelEn());
    ...
    {
        return Excel::download(new TcdBesoinPersonnelEnsExport, 'Tcd_Besoin_Personnel_Ens.xlsx');
    }
}
