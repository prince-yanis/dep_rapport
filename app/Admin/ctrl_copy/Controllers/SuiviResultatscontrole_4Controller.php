...
class SuiviResultatscontrole_4Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Gestion financière et juridique</h1>
        ...
        <span><a href="/admin/suivieffectifs/' . $resultatsscolaire->id . '/edit">Effectifs et statut des élèves de l année en cours</a></span> |
            <span>Gestion financière et juridique</span> |
    ...
    ');
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/suivicontrole_5/' . $resultatscontrole->id . '/edit');
        });
