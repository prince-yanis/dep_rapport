...
class SuiviResultatstypepersonnel_1Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Personnel encadrement</h1>
            ...
            case 2:
                ...
                $form->saved(function (Form $form) {
                    ...
                    $typepersonnel = DB::table('resultatstypepersonnel')
                        ...
                        ->where('typepersonnels_id', 4)
                        ->first();
                    return redirect('admin/suivipersonnel_2/' . $typepersonnel->id . '/edit');
                });
