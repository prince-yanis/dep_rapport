...
class EtablissementanneeInfrastructure1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
        <h1 style="text-align:center; text-transform:uppercase;">Infrastructure</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeinfrastructure1er/' . $EtabAnnee->id . '/edit">Infrastructure et Locaux</a></span>
        <span >|</span>
        ...
        <span >|</span>
            ...
            ');
                ...
                $form->hasMany('infrastructures', __(''), function (Form\NestedForm $form) {
                    ...
                    $form->select('designationinfrastructures_id', __('Désignation infrastructure'))->options($lesinfrastructures);
                    $form->text('nombre', __('Nombre'));
                    $form->text('nombrebureaux', __('Nombre de bureaux'));
                    $form->text('capacite', __("Capacité par salle"));
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneeinventaire1er/'.$EtabAnnee->id.'/edit');
