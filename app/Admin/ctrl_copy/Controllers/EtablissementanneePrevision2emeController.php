...
class EtablissementanneePrevision2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Prévisions</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeprevision2eme/' . $EtabAnnee->id . '/edit">Prévision</a></span>
        <span >|</span>
        ...
        $form->hasMany('previsions', __(''), function (Form\NestedForm $form) {
            $form->textarea('libelleprevision', __('Libelle'));
        });
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeetat2eme/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
