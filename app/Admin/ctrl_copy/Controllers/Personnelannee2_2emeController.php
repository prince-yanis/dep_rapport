...
class Personnelannee2_2emeController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        if (in_array($current_role->role_id, array(2))) {
            ...
            $grid->tools(function ($tools) {
                ...
                $tools->append('<a href="/admin/etabanneebesoinpersonneladmin/' . session('etablissementannees_id') . '/edit" class="btn btn-sm btn-success" >Suivant</a>');
            });
            ...
            $grid->cons_ens('Conseiller enseignant')->display(function ($cons_ens) {
            ...
            $grid->column('Action')->display(function () {
                return '<a href="/admin/etabanneepersonnel2eme/' . $this->id . '/edit" class= "btn btn-sm btn-primary" >Modifier</a>';
            });
        } else {
