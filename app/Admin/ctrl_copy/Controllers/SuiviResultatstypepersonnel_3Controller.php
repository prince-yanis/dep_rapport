...
class SuiviResultatstypepersonnel_3Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Autre personnel</h1>
        ...
        switch ($role_id) {
            case 2:
                ...
                $form->saved(function (Form $form) {
                    ...
                    return redirect('admin/suiviequipement/' . $typeequipement->id . '/edit');
                });
