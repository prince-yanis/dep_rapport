...
class EtablissementanneeConclusionController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeconclusion/' . $EtabAnnee->id . '/edit">Conclusion</a></span>
                <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/plannings2');
        });
        return $form;
    }
}
