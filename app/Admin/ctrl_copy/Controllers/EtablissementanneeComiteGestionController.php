...
class EtablissementanneeComiteGestionController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Comité de gestion</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneecomite/' . $EtabAnnee->id . '/edit">Comité gestion</a></span>
                <span >|</span>
        ...
        $form->hasMany('comitegestion', __(''), function (Form\NestedForm $form) {
            $form->text('nomprenoms', __('Nom prenoms'));
            $form->number('membre_comites_id', __('Membre comites id'))->options(MembreComite::all()->pluck('libellemembre', 'id'));
        });
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneesocio/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
