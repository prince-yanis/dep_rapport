...
class EtablissementanneeBesoinformationController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeprobleme/' . $EtabAnnee->id . '/edit">Problèmes Urgents</a></span>
        <span >|</span>
        ...
        $form->hasMany('besoinformation', __(''), function (Form\NestedForm $form) {
            $form->number('personnelannees_id', __('Personnelannees id'));
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeplanning/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
