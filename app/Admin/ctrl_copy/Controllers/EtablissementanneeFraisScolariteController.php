...
class EtablissementanneeFraisScolariteController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Frais d\'inscription et de scolarité</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a  style="color:red !important;" href="/admin/etabanneescolarites/' . $EtabAnnee->id . '/edit">Frais scolarité</a></span>
                <span >|</span>
        ...
        */
        ...
        $form->hasMany('fraisscolarite', __(''), function (Form\NestedForm $form) {
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneetravaux/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
