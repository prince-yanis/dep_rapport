...
class EtablissementanneeAssociationController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
        <h1 style="text-align:center; text-transform:uppercase;">Association / Club</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeassociation/'. $EtabAnnee->id .'/edit">Association/Club</a></span>
                <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneebesoin/'.$EtabAnnee->id.'/edit');
