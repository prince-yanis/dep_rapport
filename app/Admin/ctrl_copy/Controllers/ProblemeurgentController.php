...
class ProblemeurgentController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'ProblemeUrgent';
    ...
    {
        $grid = new Grid(new problemeurgent());
    ...
    {
        $show = new Show(problemeurgent::findOrFail($id));
    ...
    {
        $form = new Form(new problemeurgent());
