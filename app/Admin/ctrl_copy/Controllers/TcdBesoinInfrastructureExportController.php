...
use App\Models\TcdBesoinInfrastructure;
use Encore\Admin\Controllers\AdminController;
use App\Exports\TcdBesoinInfrastructureExport;

class TcdBesoinInfrastructureExportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'TcdBesoinInfrastructure';
    ...
    {
        $grid = new Grid(new TcdBesoinInfrastructure());
		...
		$grid->tools(function ($tools) {
			$tools->append("<a href='tcdbesoininfrastructure/export' class='btn btn-primary' target='_blank'>Export vers Excel</a>");
		});
    ...
    {
        $show = new Show(TcdBesoinInfrastructure::findOrFail($id));
    ...
    {
        $form = new Form(new TcdBesoinInfrastructure());
    ...
    {
        return Excel::download(new TcdBesoinInfrastructureExport, 'Tcd_Besoin_Infrastructure.xlsx');
    }
}
