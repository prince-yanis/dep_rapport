...
class EtablissementanneeEquipementController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Inventaire général du matériel et des équipements</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeinventaire/' . $EtabAnnee->id . '/edit">Inventaire d\'Equipement</a></span>
                <span >|</span>
        ...
        */
        ...
        $form->hasMany('equipement', __(''), function (Form\NestedForm $form) {
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneebudgets/' . $EtabAnnee->id . '/edit');
        });
