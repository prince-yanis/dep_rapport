...
class EtablissementanneeBesoinInfrastructureController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
        <h1 style="text-align:center; text-transform:uppercase;">Besoin Infrastructure</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneebesoininfrastructure/'. $EtabAnnee->id .'/edit">Besoin infrastructure</a></span>
                <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneeclasse/'.$EtabAnnee->id.'/edit');
