...
class EtablissementanneeApprenant1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a href="/admin/etabanneepersonnel1er/' . $EtabAnnee->id . '/edit">Personnels</a></span>
        <span >|</span>
        <span style="font-size: 14px";><a href="/admin/etabanneeclasse1er/' . $EtabAnnee->id . '/edit">Classe</a></span>
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeapprenant1er/'. $EtabAnnee->id .'/edit">Apprenants</a></span>
        <span >|</span>
        ...
        $form->hasMany('apprenantannees', __(''), function (Form\NestedForm $form) {
           ...
           // $apprenants = Apprenant::all();
            ...
            $form->text('moyenne1er', __('Moyenne du 1er Semestre'));
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeinfrastructure1er/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
