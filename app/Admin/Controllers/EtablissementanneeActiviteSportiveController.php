...
class EtablissementanneeActiviteSportiveController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
		...
		<div>
        <h1 style="text-align:center; text-transform:uppercase;">Activité Sportive</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeactivitesportive/'. $EtabAnnee->id .'/edit">Activités sportives</a></span>
                <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneeassociation/'.$EtabAnnee->id.'/edit');
