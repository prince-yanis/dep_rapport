...
class EtablissementanneeConclusion2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeconclusion2eme/'. $EtabAnnee->id .'/edit">Conclusion</a></span>
		<span >|</span>
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('/admin/apprenantannees_2eme');
        });
        return $form;
    }
}
