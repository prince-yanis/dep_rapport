...
class SuiviResultatscontrole_1Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Gestion pédagogique (Suivi des activités)</h1>
            ...
            case 2:
                ...
                $form->saved(function (Form $form) {
                    ...
                    $resultatscontrole = DB::table('resultatscontrole')
                        ...
                        ->where('sousrubriquecontrole_id', 2)
                        ->first();
                    return redirect('admin/suivicontrole_2/' . $resultatscontrole->id . '/edit');
                });
