...
class EtablissementanneeClasse2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeclasse2eme/' . $EtabAnnee->id . '/edit">Classe</a></span>
        <span >|</span>
