...
class EtablissementanneeSocio1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Activités Socio-Educative</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneesocio1er/'. $EtabAnnee->id .'/edit">Activités Socio-Educative</a></span>
        <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneebesoinformation1er/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
