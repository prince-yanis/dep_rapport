...
class SuiviResultatstypepersonnelController extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Personnel administratif</h1>
        ...
        switch ($role_id) {
            ...
            $form->saved(function (Form $form) {
                ...
                $typepersonnel = DB::table('resultatstypepersonnel')
                    ...
                    ->where('typepersonnels_id', 1)
                    ->first();
                return redirect('admin/suivipersonnel_1/' . $typepersonnel->id . '/edit');
            });
