...
class SuiviResultatscontrole_6Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Environnement Sécurité Hygiene et Santé</h1>
        ...
        <span>Environnement Sécurité Hygiene et Santé</span>
    ...
    ');
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/suivimissionedit/' . session('mission') . '/edit');
        });
