...
class EtablissementanneeResultat2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Resultats aux examens</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeresultat2eme/'. $EtabAnnee->id .'/edit">Resultats aux Examens</a></span>
        <span >|</span>
        ...
        $form->hasMany('resultatexamens', __(''), function (Form\NestedForm $form) {
            $lesdiplomes = array();
            ...
            $form->select('filieres_id', __('Filières'))->options($lesfilieres);
            $form->text('nombrecandidat_f', __("Nombre de candidat filles"));
            $form->text('nombrecandidat_g', __("Nombre de candidat garçons"));
            $form->text('nombrecandidat_t', __("Nombre de candidat total"));
            $form->text('nombreadmis_f', __("Nombre d'admis filles"));
            $form->text('nombreadmis_g', __("Nombre d'admis garçons"));
            $form->text('nombreadmis_t', __("Nombre d'admis total"));
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeinfrastructure2eme/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
