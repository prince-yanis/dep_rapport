...
class EtablissementDetails2emeSemestreController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                ...
                <span style="font-size: 14px;"><a style="color:red !important;" href="/admin/etablissementdetails2eme/' . session('etablissementchoisi') . '/edit">Identification</a></span>
                <span >|</span>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a href="/admin/etabanneebesoinpersonnelens/'. $EtabAnnee->id .'/edit">Besoin en Matériels et Divers</a></span>
                <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneefiliereenseigne2eme/' . $EtabAnnee->id . '/edit');
        });
