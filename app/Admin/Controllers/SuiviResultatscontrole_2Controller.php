...
class SuiviResultatscontrole_2Controller extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Gestion pédagogique (Suivi / Controle)</h1>
    ...
    ');
        ...
        $form->saved(function (Form $form) {
            ...
            $resultatscontrole = DB::table('resultatscontrole')
                ...
                ->where('sousrubriquecontrole_id', 3)
                ->first();
            return redirect('admin/suivicontrole_3/' . $resultatscontrole->id . '/edit');
        });
