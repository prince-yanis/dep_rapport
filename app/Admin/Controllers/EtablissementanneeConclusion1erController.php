...
class EtablissementanneeConclusion1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        	...
        	<div>
                <h1 style="text-align:center; text-transform:uppercase;">Conclusion</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeconclusion1er/'. $EtabAnnee->id .'/edit">Conclusion</a></span>
                <span >|</span>
        ...
        $form->hasMany('conclusion', __(''), function (Form\NestedForm $form) {
            $form->textarea('libelleconclusion', __('Libelle'));
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeplanning1er/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
