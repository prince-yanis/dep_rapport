...
use App\Models\TcdFiliereEnseigne;
use Illuminate\Support\Facades\Auth;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\TcdFiliereEnseigneExport;
use Encore\Admin\Controllers\AdminController;

class TcdFiliereEnseigneExportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'TcdFiliereEnseigne';
    ...
    {
        $grid = new Grid(new TcdFiliereEnseigne());
        ...
        $grid->column('libellefiliere', __('libellefiliere'));
        $grid->column('dureeformation', __('dureeformation'));
        $grid->column('observation', __('observation'));
		$grid->tools(function ($tools) {
			$tools->append("<a href='tcdfiliereenseigne/export' class='btn btn-primary' target='_blank'>Export vers Excel</a>");
		});
    ...
    {
        $show = new Show(TcdFiliereEnseigne::findOrFail($id));
    ...
    {
        $form = new Form(new TcdFiliereEnseigne());
    ...
    {
        return Excel::download(new TcdFiliereEnseigneExport, 'Tcd_Filiere_Enseigne.xlsx');
    }
}
