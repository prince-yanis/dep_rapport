...
use App\Models\Itemsindicateur;
...
class EtablissementanneeIndicateurController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Indicateurs de performance</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeindicateurs/' . $EtabAnnee->id . '/edit">Indicateurs</a></span>
                <span >|</span>
        ...
        */
        ...
        $form->hasMany('indicateur', __(''), function (Form\NestedForm $form) {
            $form->number('tauxobtenu_n1', __('Tauxobtenu n1'));
            $form->number('tauxcible', __('Tauxcible'));
            $form->select('itemsindicateurs_id', __('Itemsindicateurs id'))->options(Itemsindicateur::all()->pluck('libelleitems', 'id'));
        });
