...
class EtablissementanneeTravauxExterieurController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Autres ressources (productions et travaux extérieurs)</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneetravaux/' . $EtabAnnee->id . '/edit">Autres ressources</a></span>
                <span >|</span>
        ...
        $form->hasMany('travauxexterieur', __(''), function (Form\NestedForm $form) {
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneecomite/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
