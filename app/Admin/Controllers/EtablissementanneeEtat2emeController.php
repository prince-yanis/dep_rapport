...
class EtablissementanneeEtat2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Etat des difficultés de gestion et suggestions</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeetat2eme/' . $EtabAnnee->id . '/edit">Etat des difficultés gestion et suggestion</a></span>
        <span >|</span>
        ...
        $form->hasMany('etatgestion', __(''), function (Form\NestedForm $form) {
            $form->text('nature', __('Nature'));
            $form->text('difficultes', __('Difficultés'));
            $form->text('causes', __('Causes'));
            $form->textarea('suggestions', __('Suggestions'));
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeconclusion2eme/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
