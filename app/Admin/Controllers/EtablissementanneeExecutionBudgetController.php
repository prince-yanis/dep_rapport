...
class EtablissementanneeExecutionBudgetController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Etat d\'éxecution du budget</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneebudgets/' . $EtabAnnee->id . '/edit">Exécution Budget</a></span>
                <span >|</span>
        ...
        */
        ...
        $form->hasMany('executionbudget', __(''), function (Form\NestedForm $form) {
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeressources/' . $EtabAnnee->id . '/edit');
        });
