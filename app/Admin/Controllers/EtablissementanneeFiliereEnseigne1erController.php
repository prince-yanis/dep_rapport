...
class EtablissementanneeFiliereEnseigne1erController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneefiliereenseigne1er/'. $EtabAnnee->id .'/edit">Filières de Formation</a></span>
                <span >|</span>
    ...
    $form->select('filieres_id', __('Filière'))->options($filiereOptions);
        ...
        */
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneepersonnel1er/');
