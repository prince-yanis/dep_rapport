...
class Apprenantannee2_1erController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Apprenant annee 1er semestre';
    ...
    protected function grid()
    {
        ...
        if (in_array($current_role->role_id, [2])) {
            ...
            $grid->tools(function ($tools) {
                ...
                onclick="return confirm(\'Avez-vous verifier les moyennes des apprenants ?\')">J\'ai terminé mon rapport</a>');
            });
            ...
            $grid->column('Action')->display(function () {
                return '<a href="/admin/etabanneeapprenant1er/' . $this->id . '/edit" class= "btn btn-sm btn-primary" >Modifier</a>';
            });
        } else {
