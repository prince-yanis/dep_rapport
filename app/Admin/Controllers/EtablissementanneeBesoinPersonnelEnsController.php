...
class EtablissementanneeBesoinPersonnelEnsController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Besoin en Personnel Enseignant</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneebesoinpersonnelens/'. $EtabAnnee->id . '/edit">Besoin en Personnel Enseignant</a></span>
        <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneeclasse2eme/'.$EtabAnnee->id.'/edit');
