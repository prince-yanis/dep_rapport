...
class Etablissement_planningController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Emplois du temps';
        ...
        switch ($role_id) {
            case 2:
                ...
                $grid->column('Document')->display(function () {
                    return '<a href="/emploisdutemps/' . $this->id . '"  target="_blank" class="btn btn-primary">Télécharger les emplois du temps </a>';
                });
                $grid->disableActions();
