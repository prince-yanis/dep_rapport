...
class EtablissementanneeBesoinController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <div>
        <h1 style="text-align:center; text-transform:uppercase;">Besoin en Matériels et Divers</h1>
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneebesoinmateriel/'. $EtabAnnee->id .'/edit">Besoin en Matériels et Divers</a></span>
        <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            ->first();
              ...
              return redirect('admin/etabanneeprevision2eme/'.$EtabAnnee->id.'/edit');
