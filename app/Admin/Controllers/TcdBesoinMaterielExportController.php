...
use App\Models\TcdBesoinMateriel;
use Illuminate\Support\Facades\Auth;
use Maatwebsite\Excel\Facades\Excel;
use App\Exports\TcdBesoinMaterielExport;
use Encore\Admin\Controllers\AdminController;

class TcdBesoinMaterielExportController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'TcdBesoinMateriel';
    ...
    {
        $grid = new Grid(new TcdBesoinMateriel());
        ...
        $grid->column('libellemateriel', __('libellemateriel'));
        $grid->column('quantite', __('quantite'));
		$grid->tools(function ($tools) {
			$tools->append("<a href='tcdbesoinmateriel/export' class='btn btn-primary' target='_blank'>Export vers Excel</a>");
		});
    ...
    {
        $show = new Show(TcdBesoinMateriel::findOrFail($id));
    ...
    {
        $form = new Form(new TcdBesoinMateriel());
    ...
    {
        return Excel::download(new TcdBesoinMaterielExport, 'Tcd_Besoin_Materiel.xlsx');
    }
}
