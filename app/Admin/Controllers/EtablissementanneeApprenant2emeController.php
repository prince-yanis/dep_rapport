...
class EtablissementanneeApprenant2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneeapprenant2eme/' . $EtabAnnee->id . '/edit">Apprenants</a></span>
        <span >|</span>
        ...
        $form->hasMany('apprenantannees', __(''), function (Form\NestedForm $form) {
			...
			$apprenants = Apprenantannee::select('apprenants.*')
           ...
           // $form->select('classes_id', __('Classes'))->options($lesclasses)->readonly();
            ...
            //$form->select('statutapprenants_id', __('Statut'))->options($lesstatuts)->readonly();
            ...
            //$form->select('bourses_id', __('Bourse'))->options($lesbourses)->readonly();

           // $form->text('moyenne1er', __('Moyenne du 1er Semestre'))->readonly();

            $form->textarea('observation', __('Observation'))->default('Néant');

            $form->text('moyenne2eme', __('Moyenne du 2ème Semestre'));
            $form->text('moyenneannee', __('Moyenne Annuelle'));
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeresultat2eme/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
