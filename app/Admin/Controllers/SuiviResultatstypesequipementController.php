...
class SuiviResultatstypesequipementController extends AdminController
{
    /**
    ...
    <h1 style="text-align:center; text-transform:uppercase;">Infrastructures et Equipements</h1>
        ...
        <span>Infrastructures et Equipements</span> |
        ...
        switch ($role_id) {
            case 2:
                $form->hasMany('detailsequipements', __('Equipement'), function (Form\NestedForm $form) {
                    ...
                    $form->select('rubriquecontrole_id', "Rubrique controle")->options($query2)->readOnly();
                    ...
                    $form->select('equipements_id', __('Equipements'))->options($lesequipements)->readOnly();
                ...
                $form->hasMany('detailsinfrastructures', __('Infrastructure'), function (Form\NestedForm $form) {
                    ...
                    $form->select('infrastructures_id', __('Infrastructures'))->options($lesinfrastructure)->readOnly();
                ...
                $form->saved(function (Form $form) {
                    ...
                    return redirect('admin/suivicontrole_1/' . $resultatscontrole->id . '/edit');
                });
