...
class EtablissementanneeProblemeInfrastructureController extends AdminController
{
    /**
    ...
    protected function form()
    {
		...
		<div>
                <h1 style="text-align:center; text-transform:uppercase;">Problèmes liés aux infrastructures</h1>
                ...
                <span >|</span>
                <span style="font-size: 14px";><a style="color:red !important;"  href="/admin/etabanneeproblemeinfrastructures/' . $EtabAnnee->id . '/edit">Problèmes Infrastructures</a></span>
                <span >|</span>
        ...
        */
        ...
        $form->hasMany('problemeinfrastructure', __(''), function (Form\NestedForm $form) {
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneeinventaire/' . $EtabAnnee->id . '/edit');
        });
