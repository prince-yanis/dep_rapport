...
class EtablissementanneePersonnel2emeController extends AdminController
{
    /**
...
.numberCircle:after {
  padding-right: 8px;
        ...
        <span >|</span>
        <span style="font-size: 14px";><a style="color:red !important;" href="/admin/etabanneepersonnel2eme/' . $EtabAnnee->id . '/edit">Personnels</a></span>
        <span >|</span>
        ...
        $form->saved(function (Form $form) {
            ...
            return redirect('admin/etabanneebesoinpersonneladmin/' . $EtabAnnee->id . '/edit');
        });
        return $form;
    }
}
