<div id="suiviChart_2eme" style="height: 410px;"></div>

<script src="https://cdn.jsdelivr.net/npm/echarts@5.0.0/dist/echarts.min.js"></script>
<script>
    var chartDom = document.getElementById('suiviChart_2eme');
    var myChart = echarts.init(chartDom);
    var option;

    var data = [
        <?php echo json_encode($data['data'][0], 15, 512) ?>, // Valeur pour "Terminé"
        <?php echo json_encode($data['data'][1], 15, 512) ?> // Valeur pour "Non terminé"
    ];
    // Calcul du total
    ...
    option = {
        ...
        series: [{
            ...
            data: [{
                    value: <?php echo json_encode($data['data'][0], 15, 512) ?>,
                    name: 'Terminé'
                },
                {
                    value: <?php echo json_encode($data['data'][1], 15, 512) ?>,
                    name: 'Non terminé'
                }
            ],
            emphasis: {
...
<?php /**PATH C:\wamp64\www\dep_rapport\resources\views/admin/chart_suivi_2.blade.php ENDPATH**/ ?>