        ...
        series: [
            {
                ...
                data: [
                    { value: <?php echo json_encode($data['data'][0], 15, 512) ?>, name: ' Technique' },
                    { value: <?php echo json_encode($data['data'][1], 15, 512) ?>, name: ' Professionnelle' },
                    { value: <?php echo json_encode($data['data'][2], 15, 512) ?>, name: ' Supérieur' }
                ],
                emphasis: {
                    itemStyle: {
                        shadowBlur: 20,
...
<?php /**PATH C:\wamp64\www\dep_rapport\resources\views/admin/chart_etab.blade.php ENDPATH**/ ?>