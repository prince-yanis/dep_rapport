<div id="genderChart" style="height: 410px;"></div>
        ...
        color: [
            {
                ...
                y2: 1,
                colorStops: [
                    { offset: 0, color: '#00c0ef' },   // Vert foncé
            ...
            },
            {
                ...
                y2: 1,
                colorStops: [
                    { offset: 0, color: '#dd4b39' },   // Orange foncé
        ...
        series: [
            {
                ...
                data: [
                    { value: <?php echo json_encode($data['data'][0], 15, 512) ?>, name: 'Garçons' },
                    { value: <?php echo json_encode($data['data'][1], 15, 512) ?>, name: 'Filles' }
                ],
                emphasis: {
                    itemStyle: {
                        shadowBlur: 20,
...
<?php /**PATH C:\wamp64\www\dep_rapport\resources\views/admin/chart.blade.php ENDPATH**/ ?>