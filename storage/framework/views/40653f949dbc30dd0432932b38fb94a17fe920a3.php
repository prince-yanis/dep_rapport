    ...
    <div class="filter-section">
        ...
        <div class="filter-row">
            <div class="filter-group">
                ...
                <?php echo Form::select('etablissementannees_id', $etablissements, $etablissement_id ?? null, [
                    'autocomplete' => 'off',
            ...
            <div class="filter-group">
                ...
                <?php echo Form::select('personnels_id', $professeurs, null, [
                    'autocomplete' => 'off',
            ...
            <div class="filter-group">
                ...
                <?php echo Form::select('classes_id', $classes, null, [
                    'autocomplete' => 'off',
            ...
            <div class="filter-group">
                ...
                <?php echo Form::select('disciplines_id', $disciplines, null, [
                    'autocomplete' => 'off',
            ...
            <div class="modal-content">
                ...
                <form id="createEventForm" method="POST">
                    ...
                    <div id="modalBody" class="modal-body">
                        ...
                        <div class="form-group ">
                            <?php echo Form::label('datedebut', 'Date de début'); ?>

                            <div class="row">
                                <div class="col-md-6">
                                    <?php echo Form::input('date', 'datedebut_date', null, [
                                        'autocomplete' => 'off',
                                        'class' => 'form-control',
                                        'id' => 'datedebut_date',
                                ...
                                <div class="col-md-6">
                                    <?php echo Form::input('time', 'datedebut_time', null, [
                                        'autocomplete' => 'off',
                                        'class' => 'form-control',
                                        'id' => 'datedebut_time',
                                        'placeholder' => 'HH:MM',
                        ...
                        <div class="form-group ">
                            <?php echo Form::label('datefin', 'Date de fin'); ?>

                            <div class="row">
                                <div class="col-md-6">
                                    <?php echo Form::input('date', 'datefin_date', null, [
                                        'autocomplete' => 'off',
                                        'class' => 'form-control',
                                        'id' => 'datefin_date',
                                        'placeholder' => 'JJ/MM/AAAA',
                                ...
                                <div class="col-md-6">
                                    <?php echo Form::input('time', 'datefin_time', null, [
                                        'autocomplete' => 'off',
                                        'class' => 'form-control',
                                        'id' => 'datefin_time',
                                        'placeholder' => 'HH:MM',
        ...
        $(document).ready(function() {
            ...
            $("#classes").on("click", function() {
               // location.href = "/admin/apprenantannees";
				location.href = "/admin/apprenantannees2";
            });
                ...
                try {
                    ...
                    calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        events: function(fetchInfo, successCallback, failureCallback) {
                            var baseUrl = '<?php echo e(url('admin/getFilteredEvents'), false); ?>';
                            var urlParams = new URLSearchParams(window.location.search);
                            var filterParams = {};
                                    ...
                                    if (!hasEvents) {
                                        ...
                                        setTimeout(function() {
                                            ...
                                            if (calendarEl && !calendarEl.querySelector('.no-data-message')) {
                                                ...
                                                messageDiv.innerHTML = '📋 Aucun emploi du temps trouvé';
            ...
            function fetchFilteredEvents(successCallback) {
                ...
                $.ajax({
                    url: '<?php echo e(url('admin/getFilteredEvents'), false); ?>',
                    type: 'GET',
                    data: {
            ...
            $('#createEventForm').submit(function(e) {
                ...
                console.log('Calendar defined:', typeof calendar !== 'undefined');
                
                $('#createEventModal').modal('hide');
                $.post('<?php echo e(url('admin/miseajourplanning'), false); ?>', data, function(response) {
            ...
            $('#deleteButton').click(function(e) {
                ...
                $.post('<?php echo e(url('admin/supprimerplanning'), false); ?>', data, function(result) {
                    // Afficher un message de succès
...
<?php /**PATH C:\wamp64\www\dep_rapport\resources\views/calendrier/index2.blade.php ENDPATH**/ ?>